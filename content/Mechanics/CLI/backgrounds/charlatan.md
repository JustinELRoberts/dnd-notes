...
- **Tool Proficiencies.** [Disguise kit](/Mechanics/CLI/items/disguise-kit-xphb.md), [Forgery kit](/Mechanics/CLI/items/forgery-kit-xphb.md)
- **Equipment.** A set of [fine clothes](/Mechanics/CLI/items/fine-clothes-xphb.md), a [disguise kit](/Mechanics/CLI/items/disguise-kit-xphb.md), tools of the con of your choice (ten stoppered bottles filled with colored liquid, a set of weighted dice, a deck of marked cards, or a signet ring of an imaginary duke), and a belt [pouch](/Mechanics/CLI/items/pouch-xphb.md) containing 15 gp
