...
A Medium creature that hunkers behind the wall has [Half Cover](/Mechanics/CLI/variant-rules/cover-xphb.md), and a Small creature that hunkers behind it has [Three-Quarters Cover](/Mechanics/CLI/variant-rules/cover-xphb.md). The wall can be leapt over without spending any additional movement.

Each segment has AC 10 and 30 [Hit Points](/Mechanics/CLI/variant-rules/hit-points-xphb.md). Reducing a segment of the wall to 0 [Hit Points](/Mechanics/CLI/variant-rules/hit-points-xphb.md) causes it to crumble, destroying it. The wall disappears when all the segments are destroyed or the spell ends.
