...
Choose a willing creature that you can see within range. During its next turn, the target gains an additional action. That action can be used only to take the [Attack](/Mechanics/CLI/actions.md#Attack) (one weapon attack only), [Dash](/Mechanics/CLI/actions.md#Dash), [Disengage](/Mechanics/CLI/actions.md#Disengage), [Hide](/Mechanics/CLI/actions.md#Hide), or [Utilize](/Mechanics/CLI/actions.md#Utilize) action.
