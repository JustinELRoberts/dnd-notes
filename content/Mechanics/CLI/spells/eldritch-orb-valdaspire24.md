...
You fling a ball of eldritch energy at a creature or object within range. Make a ranged spell attack against the target. On a hit, the target takes `1d8` Force damage and explodes in a 5-foot [Emanation](/Mechanics/CLI/variant-rules/emanation-area-of-effect-xphb.md). Each creature other than the target within the [Emanation](/Mechanics/CLI/variant-rules/emanation-area-of-effect-xphb.md) makes a Dexterity saving throw, taking half the amount of Force damage on a failed save, or none on a successful one.
