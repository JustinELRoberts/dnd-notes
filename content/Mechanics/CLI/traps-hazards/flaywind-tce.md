...
A flaywind leaves `4d6` feet of sand or debris in its wake. A successful DC 15 Intelligence ([Arcana](/Mechanics/CLI/skills.md#Arcana)) or ([Nature](/Mechanics/CLI/skills.md#Nature)) check or Wisdom ([Survival](/Mechanics/CLI/skills.md#Survival)) check allows a character to recognize a flaywind 1 minute before it strikes, allowing time to seek shelter. A flaywind typically lasts `1d4 × 10` hours.
