...
When the temperature is at or above 100 degrees Fahrenheit, a creature exposed to the heat and without access to drinkable water must succeed on a Constitution saving throw at the end of each hour or gain one level of [exhaustion](/Mechanics/CLI/conditions.md#Exhaustion). The DC is 5 for the first hour and increases by 1 for each additional hour.
