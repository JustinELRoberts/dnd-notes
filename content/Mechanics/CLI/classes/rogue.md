...
aliases:
  - Rogue
created: 2026-03-30T01:53:55.934Z
modified: 2026-03-30T01:53:55.934Z
published: 2026-03-30T01:53:55.934Z
tags:
...
- **Armor**: [light armor](/Mechanics/CLI/item-types.md#Light%20Armor)
- **Weapons**: simple weapons, [hand crossbows](/Mechanics/CLI/items/hand-crossbow.md), [longswords](/Mechanics/CLI/items/longsword.md), [rapiers](/Mechanics/CLI/items/rapier.md), [shortswords](/Mechanics/CLI/items/shortsword.md)
- **Tools**: [thieves' tools](/Mechanics/CLI/items/thieves-tools-xphb.md)
- **Skills**: choose 4 from [Acrobatics](/Mechanics/CLI/skills.md#Acrobatics), [Athletics](/Mechanics/CLI/skills.md#Athletics), [Deception](/Mechanics/CLI/skills.md#Deception), [Insight](/Mechanics/CLI/skills.md#Insight), [Intimidation](/Mechanics/CLI/skills.md#Intimidation), [Investigation](/Mechanics/CLI/skills.md#Investigation), [Perception](/Mechanics/CLI/skills.md#Perception), [Performance](/Mechanics/CLI/skills.md#Performance), [Persuasion](/Mechanics/CLI/skills.md#Persuasion), [Sleight of Hand](/Mechanics/CLI/skills.md#Sleight%20of%20Hand), and [Stealth](/Mechanics/CLI/skills.md#Stealth)

You start with the following items, plus anything provided by your background.

- (a) a [rapier](/Mechanics/CLI/items/rapier.md) or (b) a [shortsword](/Mechanics/CLI/items/shortsword.md)
- (a) a [shortbow](/Mechanics/CLI/items/shortbow.md) and [quiver](/Mechanics/CLI/items/quiver-xphb.md) of [20 arrows](/Mechanics/CLI/items/arrows-20.md) or (b) a [shortsword](/Mechanics/CLI/items/shortsword.md)
- (a) a [burglar's pack](/Mechanics/CLI/items/burglars-pack-xphb.md), (b) a [dungeoneer's pack](/Mechanics/CLI/items/dungeoneers-pack-xphb.md), or (c) an [explorer's pack](/Mechanics/CLI/items/explorers-pack-xphb.md)
- [Leather armor](/Mechanics/CLI/items/leather-armor.md), two [daggers](/Mechanics/CLI/items/dagger.md), and [thieves' tools](/Mechanics/CLI/items/thieves-tools-xphb.md)
...
- **Armor**: [light armor](/Mechanics/CLI/item-types.md#Light%20Armor)
- **Tools**: [thieves' tools](/Mechanics/CLI/items/thieves-tools-xphb.md)
- **Skills**: choose 1 from [Acrobatics](/Mechanics/CLI/skills.md#Acrobatics), [Athletics](/Mechanics/CLI/skills.md#Athletics), [Deception](/Mechanics/CLI/skills.md#Deception), [Insight](/Mechanics/CLI/skills.md#Insight), [Intimidation](/Mechanics/CLI/skills.md#Intimidation), [Investigation](/Mechanics/CLI/skills.md#Investigation), [Perception](/Mechanics/CLI/skills.md#Perception), [Performance](/Mechanics/CLI/skills.md#Performance), [Persuasion](/Mechanics/CLI/skills.md#Persuasion), [Sleight of Hand](/Mechanics/CLI/skills.md#Sleight%20of%20Hand), and [Stealth](/Mechanics/CLI/skills.md#Stealth)
...
You can make a rogue quickly by following these suggestions. First, Dexterity should be your highest ability score. Make Intelligence your next-highest if you want to excel at Investigation or plan to take up the Arcane Trickster archetype. Choose Charisma instead if you plan to emphasize deception and social interaction. Second, choose the [charlatan](/Mechanics/CLI/backgrounds/charlatan.md) background.
...
At 1st level, choose two of your skill proficiencies, or one of your skill proficiencies and your proficiency with [thieves' tools](/Mechanics/CLI/items/thieves-tools-xphb.md). Your proficiency bonus is doubled for any ability check you make that uses either of the chosen proficiencies.

At 6th level, you can choose two more of your proficiencies (in skills or with [thieves' tools](/Mechanics/CLI/items/thieves-tools-xphb.md)) to gain this benefit.

### Sneak Attack (Level 1)

Beginning at 1st level, you know how to strike subtly and exploit a foe's distraction. Once per turn, you can deal an extra `1d6` damage to one creature you hit with an attack if you have advantage on the attack roll. The attack must use a finesse or a ranged weapon.

You don't need advantage on the attack roll if another enemy of the target is within 5 feet of it, that enemy isn't [incapacitated](/Mechanics/CLI/conditions.md#Incapacitated), and you don't have disadvantage on the attack roll.
...
Starting at 2nd level, your quick thinking and agility allow you to move and act quickly. You can take a bonus action on each of your turns in combat. This action can be used only to take the [Dash](/Mechanics/CLI/actions.md#Dash), [Disengage](/Mechanics/CLI/actions.md#Disengage), or [Hide](/Mechanics/CLI/actions.md#Hide) action.
...
_3rd-level rogue [optional feature](/Mechanics/CLI/variant-rules/optional-class-features-tce.md)_
...
At 6th level, you can choose two more of your proficiencies (in skills or with [thieves' tools](/Mechanics/CLI/items/thieves-tools-xphb.md)) to gain the benefit of Expertise.

### Evasion (Level 7)

Beginning at 7th level, you can nimbly dodge out of the way of certain area effects, such as a red dragon's fiery breath or an [ice storm](/Mechanics/CLI/spells/ice-storm-xphb.md) spell. When you are subjected to an effect that allows you to make a Dexterity saving throw to take only half damage, you instead take no damage if you succeed on the saving throw, and only half damage if you fail.
...
Starting at 14th level, if you are able to hear, you are aware of the location of any hidden or [invisible](/Mechanics/CLI/conditions.md#Invisible) creature within 10 feet of you.
...
Beginning at 18th level, you are so evasive that attackers rarely gain the upper hand against you. No attack roll has advantage against you while you aren't [incapacitated](/Mechanics/CLI/conditions.md#Incapacitated).
...
_Player's Handbook p. 94. Available in the <span title='Systems Reference Document (5.1)'>SRD</span> and the Basic Rules (2014)_
