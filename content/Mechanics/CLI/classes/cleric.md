...
aliases:
  - Cleric
created: 2026-03-30T01:53:55.645Z
modified: 2026-03-30T01:53:55.645Z
published: 2026-03-30T01:53:55.645Z
tags:
...
- **Tools**: none
- **Skills**: choose 2 from [History](/Mechanics/CLI/skills.md#History), [Insight](/Mechanics/CLI/skills.md#Insight), [Medicine](/Mechanics/CLI/skills.md#Medicine), [Persuasion](/Mechanics/CLI/skills.md#Persuasion), and [Religion](/Mechanics/CLI/skills.md#Religion)

You start with the following items, plus anything provided by your background.

- (a) a [mace](/Mechanics/CLI/items/mace.md) or (b) a [warhammer](/Mechanics/CLI/items/warhammer.md) (if proficient)
- (a) [scale mail](/Mechanics/CLI/items/scale-mail.md), (b) [leather armor](/Mechanics/CLI/items/leather-armor.md), or (c) [chain mail](/Mechanics/CLI/items/chain-mail.md) (if proficient)
...
- A [shield](/Mechanics/CLI/items/shield.md) and a [holy symbol](/Mechanics/CLI/items/holy-symbol-xphb.md)
...
You can make a cleric quickly by following these suggestions. First, Wisdom should be your highest ability score, followed by Strength or Constitution. Second, choose the [acolyte](/Mechanics/CLI/backgrounds/acolyte.md) background.
...
**Spellcasting Focus.** You can use a [holy symbol](/Mechanics/CLI/items/holy-symbol-xphb.md) as a spellcasting focus for your cleric spells.
...
A turned creature must spend its turns trying to move as far away from you as it can, and it can't willingly move to a space within 30 feet of you. It also can't take reactions. For its action, it can use only the [Dash](/Mechanics/CLI/actions.md#Dash) action or try to escape from an effect that prevents it from moving. If there's nowhere to move, the creature can use the [Dodge](/Mechanics/CLI/actions.md#Dodge) action.

### Channel Divinity: Harness Divine Power (Level 2)

_Source: Tasha's Cauldron of Everything p. 30_

_2nd-level cleric [optional feature](/Mechanics/CLI/variant-rules/optional-class-features-tce.md)_
...
_4th-level cleric [optional feature](/Mechanics/CLI/variant-rules/optional-class-features-tce.md)_
...
_Player's Handbook p. 56. Available in the <span title='Systems Reference Document (5.1)'>SRD</span> and the Basic Rules (2014)_
