...
_Travel the Land with a Good Dog at Your Side_
...
**The Hound in Combat.** In combat, your hound acts during your turn. It can move and use its [Reaction](/Mechanics/CLI/variant-rules/reaction-xphb.md) on its own, but the only action it takes is the [Dodge](/Mechanics/CLI/actions.md#Dodge) action unless you take a [Bonus Action](/Mechanics/CLI/variant-rules/bonus-action-xphb.md) to command it to take an action in its stat block or some other action. If you have the [Incapacitated](/Mechanics/CLI/conditions.md#Incapacitated) condition, the hound acts on its own and isn't limited to the [Dodge](/Mechanics/CLI/actions.md#Dodge) action.

**The Hound Dropping to 0 Hit Points.** If the hound drops to 0 [Hit Points](/Mechanics/CLI/variant-rules/hit-points-xphb.md), it has the [Unconscious](/Mechanics/CLI/conditions.md#Unconscious) condition until you finish a [Long Rest](/Mechanics/CLI/variant-rules/long-rest-xphb.md) or it regains any [Hit Points](/Mechanics/CLI/variant-rules/hit-points-xphb.md). When you finish a [Short](/Mechanics/CLI/variant-rules/short-rest-xphb.md) or [Long Rest](/Mechanics/CLI/variant-rules/long-rest-xphb.md), it regains all of its [Hit Points](/Mechanics/CLI/variant-rules/hit-points-xphb.md) and loses this condition. See the sidebar "Does the Dog Die?" for information about losing or replacing your hound.
...
As a [Bonus Action](/Mechanics/CLI/variant-rules/bonus-action-xphb.md), you can expend one Battle Die to command your hound to attack a creature you can see within 40 feet of it. The hound moves up to its [Speed](/Mechanics/CLI/variant-rules/speed-xphb.md) without provoking [Opportunity Attacks](/Mechanics/CLI/actions.md#Opportunity%20Attack) and makes one Bite attack against the target, adding the Battle Die to its attack and damage roll.

### Desperate Companion (Level 3)

While you are [Bloodied](/Mechanics/CLI/conditions.md#Bloodied), your hound has [Advantage](/Mechanics/CLI/variant-rules/advantage-xphb.md) on attack rolls.

### Hound's Instincts (Level 6)

Your dog has a sixth sense for danger.

**Blindsight.** The hound has [Blindsight](/Mechanics/CLI/senses.md#Blindsight) with a range of 30 feet.
...
When a creature you can see hits your hound while it is within 5 feet of yourself with an attack roll, you can take a [Reaction](/Mechanics/CLI/variant-rules/reaction-xphb.md) to force the attack to hit you instead. Alternatively, your hound can take a [Reaction](/Mechanics/CLI/variant-rules/reaction-xphb.md) to use this feature to cause an attack that hits you to hit it instead.
