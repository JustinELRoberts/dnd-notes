...
For example, if you know the 1st-level spell [shield](/Mechanics/CLI/spells/shield-xphb.md) and have a 1st-level and a 2nd-level spell slot available, you can cast [shield](/Mechanics/CLI/spells/shield-xphb.md) using either slot.
...
Once you have bonded a weapon to yourself, you can't be disarmed of that weapon unless you are [incapacitated](/Mechanics/CLI/conditions.md#Incapacitated). If it is on the same plane of existence, you can summon that weapon as a bonus action on your turn, causing it to teleport instantly to your hand.
