...
Beginning at 10th level, when you cast an abjuration spell that requires you to make an ability check as a part of casting that spell (as in [counterspell](/Mechanics/CLI/spells/counterspell-xphb.md) and [dispel magic](/Mechanics/CLI/spells/dispel-magic-xphb.md)), you add your proficiency bonus to that ability check.
