...
aliases:
  - Warlock
created: 2026-03-30T01:53:56.175Z
modified: 2026-03-30T01:53:56.175Z
published: 2026-03-30T01:53:56.175Z
tags:
...
- **Tools**: none
- **Skills**: choose 2 from [Arcana](/Mechanics/CLI/skills.md#Arcana), [Deception](/Mechanics/CLI/skills.md#Deception), [History](/Mechanics/CLI/skills.md#History), [Intimidation](/Mechanics/CLI/skills.md#Intimidation), [Investigation](/Mechanics/CLI/skills.md#Investigation), [Nature](/Mechanics/CLI/skills.md#Nature), and [Religion](/Mechanics/CLI/skills.md#Religion)

You start with the following items, plus anything provided by your background.

- (a) a [light crossbow](/Mechanics/CLI/items/light-crossbow.md) and [20 bolts](/Mechanics/CLI/items/crossbow-bolts-20.md) or (b) any simple weapon
- (a) a [component pouch](/Mechanics/CLI/items/component-pouch-xphb.md) or (b) an [arcane focus](/Mechanics/CLI/items/arcane-focus-xphb.md)
- (a) a [scholar's pack](/Mechanics/CLI/items/scholars-pack-xphb.md) or (b) a [dungeoneer's pack](/Mechanics/CLI/items/dungeoneers-pack-xphb.md)
- [Leather armor](/Mechanics/CLI/items/leather-armor.md), any simple weapon, and two [daggers](/Mechanics/CLI/items/dagger.md)
...
You can make a warlock quickly by following these suggestions. First, Charisma should be your highest ability score, followed by Constitution. Second, choose the [charlatan](/Mechanics/CLI/backgrounds/charlatan.md) background. Third, choose the [eldritch blast](/Mechanics/CLI/spells/eldritch-blast-xphb.md) and [chill touch](/Mechanics/CLI/spells/chill-touch-xphb.md) cantrips, along with the 1st-level spells [charm person](/Mechanics/CLI/spells/charm-person-xphb.md) and [witch bolt](/Mechanics/CLI/spells/witch-bolt-xphb.md).
...
For example, when you are 5th level, you have two 3rd-level spell slots. To cast the 1st-level spell [witch bolt](/Mechanics/CLI/spells/witch-bolt-xphb.md), you must spend one of those slots, and you cast it as a 3rd-level spell.
...
**Spellcasting Focus.** You can use an [arcane focus](/Mechanics/CLI/items/arcane-focus-xphb.md) as a spellcasting focus for your warlock spells.
...
At 2nd level, you gain two eldritch invocations of your choice. A list of the available options can be found on the [Optional Features](/Mechanics/CLI/lists/list-optfeaturetype-ei.md) page. When you gain certain warlock levels, you gain additional invocations of your choice, as shown in the Invocations Known column of the Warlock table.
...
- [Pact of the Talisman](/Mechanics/CLI/optional-features/pact-of-the-talisman-tce.md)
...
_4th-level warlock [optional feature](/Mechanics/CLI/variant-rules/optional-class-features-tce.md)_
...
> ![Pact Boon](/Mechanics/CLI/lists/list-optfeaturetype-pb.md#Pact%20Boon)
> ^list-optfeature-pb

## Sources

_Player's Handbook p. 105. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>_
