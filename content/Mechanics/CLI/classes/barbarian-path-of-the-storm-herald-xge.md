...
- **Sea**\
  When you hit a creature in your aura with an attack, you can use your reaction to force that creature to make a Strength saving throw. On a failed save, the creature is knocked [prone](/Mechanics/CLI/conditions.md#Prone), as if struck by a wave.
- **Tundra**\
...
_Xanathar's Guide to Everything p. 10_
