...
- **Armor**: [light armor](/Mechanics/CLI/item-types.md#Light%20Armor), [medium armor](/Mechanics/CLI/item-types.md#Medium%20Armor), [heavy armor](/Mechanics/CLI/item-types.md#Heavy%20Armor), [shields](/Mechanics/CLI/items/shield.md)
- **Weapons**: simple weapons, martial weapons
- **Tools**: none
- **Skills**: choose 2 from [Athletics](/Mechanics/CLI/skills.md#Athletics), [Insight](/Mechanics/CLI/skills.md#Insight), [Intimidation](/Mechanics/CLI/skills.md#Intimidation), [Medicine](/Mechanics/CLI/skills.md#Medicine), [Persuasion](/Mechanics/CLI/skills.md#Persuasion), and [Religion](/Mechanics/CLI/skills.md#Religion)

You start with the following items, plus anything provided by your background.

- (a) a martial weapon and a [shield](/Mechanics/CLI/items/shield.md) or (b) two martial weapons
- (a) five [javelins](/Mechanics/CLI/items/javelin.md) or (b) any simple melee weapon
- (a) a [priest's pack](/Mechanics/CLI/items/priests-pack-xphb.md) or (b) an [explorer's pack](/Mechanics/CLI/items/explorers-pack-xphb.md)
- [Chain mail](/Mechanics/CLI/items/chain-mail.md) and a [holy symbol](/Mechanics/CLI/items/holy-symbol-xphb.md)
...
You can make a paladin quickly by following these suggestions. First, Strength should be your highest ability score, followed by Charisma. Second, choose the [noble](/Mechanics/CLI/backgrounds/noble.md) background.
...
The presence of strong evil registers on your senses like a noxious odor, and powerful good rings like heavenly music in your ears. As an action, you can open your awareness to detect such forces. Until the end of your next turn, you know the location of any celestial, fiend, or undead within 60 feet of you that is not behind total cover. You know the type (celestial, fiend, or undead) of any being whose presence you sense, but not its identity (the vampire Count Strahd von Zarovich, for instance). Within the same radius, you also detect the presence of any place or object that has been consecrated or desecrated, as with the [hallow](/Mechanics/CLI/spells/hallow-xphb.md) spell.
...
- [Blessed Warrior](/Mechanics/CLI/feats/blessed-warrior-xphb.md)
...
**Spellcasting Focus.** You can use a [holy symbol](/Mechanics/CLI/items/holy-symbol-xphb.md) as a spellcasting focus for your paladin spells.
...
_3rd-level paladin [optional feature](/Mechanics/CLI/variant-rules/optional-class-features-tce.md)_
...
_4th-level paladin [optional feature](/Mechanics/CLI/variant-rules/optional-class-features-tce.md)_

Whenever you reach a level in this class that grants the Ability Score Improvement feature, you can replace a [fighting style](/Mechanics/CLI/lists/list-optfeaturetype-fs-p.md) you know with another fighting style available to paladins. This replacement represents a shift of focus in your martial practice.
...
Starting at 10th level, you and friendly creatures within 10 feet of you can't be [frightened](/Mechanics/CLI/conditions.md#Frightened) while you are conscious.
...
> ![Fighting Style, Paladin](/Mechanics/CLI/lists/list-optfeaturetype-fs-p.md#Fighting%20Style,%20Paladin)
> ^list-optfeature-fs-p

## Sources

_Player's Handbook p. 82. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>_
