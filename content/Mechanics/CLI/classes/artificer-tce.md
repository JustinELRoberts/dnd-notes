...
aliases:
  - Artificer
created: 2026-03-30T01:53:56.131Z
modified: 2026-03-30T01:53:56.131Z
published: 2026-03-30T01:53:56.131Z
tags:
...
> <li>‡1: Optional features from <a href="/Mechanics/CLI/lists/list-optfeaturetype-ai.md">Artificer Infusion</a>; defined in Tasha's Cauldron of Everything</li>
> </ul></section>
...
- **Tools**: [thieves' tools](/Mechanics/CLI/items/thieves-tools-xphb.md), [tinker's tools](/Mechanics/CLI/items/tinkers-tools-xphb.md), one type of [artisan's tools](/Mechanics/CLI/items/artisans-tools-xphb.md) of your choice
- **Skills**: choose 2 from [Arcana](/Mechanics/CLI/skills.md#Arcana), [History](/Mechanics/CLI/skills.md#History), [Investigation](/Mechanics/CLI/skills.md#Investigation), [Medicine](/Mechanics/CLI/skills.md#Medicine), [Nature](/Mechanics/CLI/skills.md#Nature), [Perception](/Mechanics/CLI/skills.md#Perception), and [Sleight of Hand](/Mechanics/CLI/skills.md#Sleight%20of%20Hand)

You start with the following items, plus anything provided by your background.

- any two simple weapons of your choice
- a [light crossbow](/Mechanics/CLI/items/light-crossbow.md) and [20 bolts](/Mechanics/CLI/items/crossbow-bolts-20.md)
- (a) [studded leather armor](/Mechanics/CLI/items/studded-leather-armor.md) or (b) [scale mail](/Mechanics/CLI/items/scale-mail.md)
- [thieves' tools](/Mechanics/CLI/items/thieves-tools-xphb.md) and a [dungeoneer's pack](/Mechanics/CLI/items/dungeoneers-pack-xphb.md)
...
- **Armor**: [light armor](/Mechanics/CLI/item-types.md#Light%20Armor), [medium armor](/Mechanics/CLI/item-types.md#Medium%20Armor), [shields](/Mechanics/CLI/items/shield.md)
- **Tools**: [thieves' tools](/Mechanics/CLI/items/thieves-tools-xphb.md), [tinker's tools](/Mechanics/CLI/items/tinkers-tools-xphb.md)
...
If artificer isn't your initial class, here are the proficiencies you gain when you take your first level as an artificer: light armor, medium armor, shields, [thieves' tools](/Mechanics/CLI/items/thieves-tools-xphb.md), [tinker's tools](/Mechanics/CLI/items/tinkers-tools-xphb.md).
...
Masters of unlocking magic in everyday objects, artificers are supreme inventors. They see magic as a complex system waiting to be decoded and controlled. Artificers use tools to channel arcane power, crafting magical objects. To cast a spell, an artificer could use [alchemist's supplies](/Mechanics/CLI/items/alchemists-supplies-xphb.md) to create a potent elixir, [calligrapher's supplies](/Mechanics/CLI/items/calligraphers-supplies-xphb.md) to inscribe a sigil of power on an ally's armor, or [tinker's tools](/Mechanics/CLI/items/tinkers-tools-xphb.md) to craft a temporary charm. The magic of artificers is tied to their tools and their talents.
...
You can make an artificer quickly by following these suggestions. First, put your highest ability score in Intelligence, followed by Constitution or Dexterity. Second, choose the [guild artisan](/Mechanics/CLI/backgrounds/guild-artisan.md) background.
...
**Tools Required.** You produce your artificer spell effects through your tools. You must have a spellcasting focus—specifically [thieves' tools](/Mechanics/CLI/items/thieves-tools-xphb.md) or some kind of [artisan's tool](/Mechanics/CLI/items/artisans-tools-xphb.md)—in hand when you cast any spell with this Spellcasting feature (meaning the spell has an 'M' component when you cast it). You must be proficient with the tool to use it in this way. See "chapter 5", "Equipment," in the "Player's Handbook" for descriptions of these tools.

After you gain the Infuse Item feature at 2nd level, you can also use any item bearing one of your infusions as a spellcasting focus.

> [!note] The Magic of Artifice
>
> As an artificer, you use tools when you cast your spells. When describing your spellcasting, think about how you're using a tool to perform the spell effect. If you cast [cure wounds](/Mechanics/CLI/spells/cure-wounds-xphb.md) using [alchemist's supplies](/Mechanics/CLI/items/alchemists-supplies-xphb.md), you could be quickly producing a salve. If you cast it using [tinker's tools](/Mechanics/CLI/items/tinkers-tools-xphb.md), you might have a miniature mechanical spider that binds wounds. When you cast [poison spray](/Mechanics/CLI/spells/poison-spray-xphb.md), you could fling foul chemicals or use a wand that spits venom. The effect of the spell is the same as for a spellcaster of any other class, but your method of spellcasting is special.
>
> The same principle applies when you prepare your spells. As an artificer, you don't study a spellbook or pray to prepare your spells. Instead, you work with your tools and create the specialized items you'll use to produce your effects. If you replace [cure wounds](/Mechanics/CLI/spells/cure-wounds-xphb.md) with [heat metal](/Mechanics/CLI/spells/heat-metal-xphb.md), you might be altering the device you use to heal—perhaps modifying a tool so that it channels heat instead of healing energy.
>
...
When you gain this feature, pick four artificer infusions to learn, choosing from the "Artificer Infusions^\[Optional features from [Artificer Infusion](/Mechanics/CLI/lists/list-optfeaturetype-ai.md); defined in Tasha's Cauldron of Everything]" section at the end of the class's description. You learn additional infusions of your choice when you reach certain levels in this class, as shown in the Infusions Known column of the Artificer table.
...
If an infusion ends on an item that contains other things, like a [bag of holding](/Mechanics/CLI/items/bag-of-holding.md), its contents harmlessly appear in and around its space.
...
You've learned how to produce exactly the tool you need: with [thieves' tools](/Mechanics/CLI/items/thieves-tools-xphb.md) or [artisan's tools](/Mechanics/CLI/items/artisans-tools-xphb.md) in hand, you can magically create one set of [artisan's tools](/Mechanics/CLI/items/artisans-tools-xphb.md) in an unoccupied space within 5 feet of you. This creation requires 1 hour of uninterrupted work, which can coincide with a short or long rest. Though the product of magic, the tools are nonmagical, and they vanish when you use this feature again.
...
While holding the object, a creature can take an action to produce the spell's effect from it, using your spellcasting ability modifier. If the spell requires [concentration](/Mechanics/CLI/conditions.md#Concentration), the creature must concentrate. The spell stays in the object until it's been used a number of times equal to twice your Intelligence modifier (minimum of twice) or until you use this feature again to store a spell in an object.
...
> ![Artificer Infusion](/Mechanics/CLI/lists/list-optfeaturetype-ai.md#Artificer%20Infusion)
> ^list-optfeature-ai

## Sources

_Tasha's Cauldron of Everything p. 9_
