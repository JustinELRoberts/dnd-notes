...
aliases:
  - Reanimator
created: 2026-03-30T01:53:56.149Z
modified: 2026-03-30T01:53:56.149Z
published: 2026-03-30T01:53:56.149Z
tags:
...
You gain proficiency in the [Medicine](/Mechanics/CLI/skills.md#Medicine) skill, if you didn't already have it. Additionally, you gain a bonus to checks using this skill equal to your Intelligence modifier (minimum bonus of +1).

### Spell-Stitching (Level 3)

You can inscribe magical effects into your thralls with gruesome Spell-Stitches. You can expend [Charnel Touch](/Mechanics/CLI/classes/necromancer-valdaspire24.md#Charnel%20Touch%20\(Level%201\)) points to apply Spell-Stitches to your thralls over the course of 1 hour, which can be done during a [Short](/Mechanics/CLI/variant-rules/short-rest-xphb.md) or [Long Rest](/Mechanics/CLI/variant-rules/long-rest-xphb.md). The number of Charnel Touch points required to apply each stitch is listed in parentheses. Each thrall can have a maximum of two stitches, which last until the thrall dies or you apply a new stitch to replace it.

**Armored Stitch (15 Charnel Touch Points).** The thrall's AC becomes 18 if it were lower.

**Fleet Stitch (5 Charnel Touch Points).** The thrall's [Speed](/Mechanics/CLI/variant-rules/speed-xphb.md) is doubled.

**Skilled Stitch (5 Charnel Touch Points).** The thrall has proficiency in all of your skills.

**Tough Stitch (10 Charnel Touch Points).** The thrall's [Hit Point](/Mechanics/CLI/variant-rules/hit-points-xphb.md) maximum and current [Hit Points](/Mechanics/CLI/variant-rules/hit-points-xphb.md) increase by twice your Necromancer level.

**Vicious Stitch (10 Charnel Touch Points).** The thrall has [Advantage](/Mechanics/CLI/variant-rules/advantage-xphb.md) on the first attack roll it makes on each of its turns.

### Charnel Voltage (Level 3)

When you deal 5 or more damage with [Charnel Touch](/Mechanics/CLI/classes/necromancer-valdaspire24.md#Charnel%20Touch%20\(Level%201\)), you can deal Lightning damage instead of Necrotic damage and cause the energy to arc to a second creature within 5 feet of the target. The second creature must succeed on a Dexterity saving throw against your spell save DC or take Lightning damage equal to half of the number of Charnel Touch points expended. A creature that takes Lightning damage from this feature can't make [Opportunity Attacks](/Mechanics/CLI/actions.md#Opportunity%20Attack) until the start of its next turn.

### Lazarus Bolt (Level 6)

As a [Magic](/Mechanics/CLI/actions.md#Magic) action, you can drive a bolt into the torso of a creature within 5 feet of you that has died within the last minute and shock it back to life. That creature revives with 1 [Hit Point](/Mechanics/CLI/variant-rules/hit-points-xphb.md) and gains [Temporary Hit Points](/Mechanics/CLI/variant-rules/temporary-hit-points-xphb.md) equal to twice your Necromancer level. This feature can't return to life a creature that lacks a heart, a creature that has died of old age, or a creature that is missing vital organs.

Once you use this feature, you can't use it again until you finish a [Long Rest](/Mechanics/CLI/variant-rules/long-rest-xphb.md). You can also restore your use of it by expending 20 [Charnel Touch](/Mechanics/CLI/classes/necromancer-valdaspire24.md#Charnel%20Touch%20\(Level%201\)) points (no action required).

### Quick Stitch (Level 10)

As a [Magic](/Mechanics/CLI/actions.md#Magic) action, you can apply a Spell-Stitch to one of your thralls, expending [Charnel Touch](/Mechanics/CLI/classes/necromancer-valdaspire24.md#Charnel%20Touch%20\(Level%201\)) points as normal. This stitch lasts for 10 minutes and can exceed the thrall's maximum of two stitches.
...
**Self-Stitches.** You can apply any number of Spell-Stiches to yourself as a [Magic](/Mechanics/CLI/actions.md#Magic) action, expending [Charnel Touch](/Mechanics/CLI/classes/necromancer-valdaspire24.md#Charnel%20Touch%20\(Level%201\)) points as normal. Spell-Stitches applied in this way last until you finish a [Long Rest](/Mechanics/CLI/variant-rules/long-rest-xphb.md).
