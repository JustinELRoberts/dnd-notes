...
aliases:
  - Wizard
created: 2026-03-30T01:53:55.944Z
modified: 2026-03-30T01:53:55.944Z
published: 2026-03-30T01:53:55.944Z
tags:
...
- **Armor**: none
- **Weapons**: [daggers](/Mechanics/CLI/items/dagger.md), [darts](/Mechanics/CLI/items/dart.md), [slings](/Mechanics/CLI/items/sling.md), [quarterstaffs](/Mechanics/CLI/items/quarterstaff.md), [light crossbows](/Mechanics/CLI/items/light-crossbow.md)
- **Tools**: none
- **Skills**: choose 2 from [Arcana](/Mechanics/CLI/skills.md#Arcana), [History](/Mechanics/CLI/skills.md#History), [Insight](/Mechanics/CLI/skills.md#Insight), [Investigation](/Mechanics/CLI/skills.md#Investigation), [Medicine](/Mechanics/CLI/skills.md#Medicine), and [Religion](/Mechanics/CLI/skills.md#Religion)

You start with the following items, plus anything provided by your background.

- (a) a [quarterstaff](/Mechanics/CLI/items/quarterstaff.md) or (b) a [dagger](/Mechanics/CLI/items/dagger.md)
...
- (a) a [scholar's pack](/Mechanics/CLI/items/scholars-pack-xphb.md) or (b) an [explorer's pack](/Mechanics/CLI/items/explorers-pack-xphb.md)
- A [spellbook](/Mechanics/CLI/items/spellbook.md)
...
You can make a wizard quickly by following these suggestions. First, Intelligence should be your highest ability score, followed by Constitution or Dexterity. If you plan to join the School of Enchantment, make Charisma your next-best score. Second, choose the [sage](/Mechanics/CLI/backgrounds/sage.md) background. Third, choose the [mage hand](/Mechanics/CLI/spells/mage-hand-xphb.md), [light](/Mechanics/CLI/spells/light-xphb.md), and [ray of frost](/Mechanics/CLI/spells/ray-of-frost-xphb.md) cantrips, along with the following 1st-level spells for your spellbook: [burning hands](/Mechanics/CLI/spells/burning-hands-xphb.md), [charm person](/Mechanics/CLI/spells/charm-person-xphb.md), [feather fall](/Mechanics/CLI/spells/feather-fall-xphb.md), [mage armor](/Mechanics/CLI/spells/mage-armor-xphb.md), [magic missile](/Mechanics/CLI/spells/magic-missile-xphb.md), and [sleep](/Mechanics/CLI/spells/sleep-xphb.md).
...
For example, if you're a 3rd-level wizard, you have four 1st-level and two 2nd-level spell slots. With an Intelligence of 16, your list of prepared spells can include six spells of 1st or 2nd level, in any combination, chosen from your spellbook. If you prepare the 1st-level spell [magic missile](/Mechanics/CLI/spells/magic-missile-xphb.md), you can cast it using a 1st-level or a 2nd-level slot. Casting the spell doesn't remove it from your list of prepared spells.
...
**Spellcasting Focus.** You can use an [arcane focus](/Mechanics/CLI/items/arcane-focus-xphb.md) as a spellcasting focus for your wizard spells.
...
>
> **Copying from a Spell Scroll.** A wizard spell on a spell scroll can be copied just as spells in spellbooks can be copied. When you copy a spell from a spell scroll, you must succeed on an Intelligence ([Arcana](/Mechanics/CLI/skills.md#Arcana)) check with a DC equal to 10 + the spell's level. If the check succeeds, the spell is successfully copied. Whether the check succeeds or fails, the spell scroll is destroyed.
>
...
_3rd-level wizard [optional feature](/Mechanics/CLI/variant-rules/optional-class-features-tce.md)_
...
_Player's Handbook p. 112. Available in the <span title='Systems Reference Document (5.1)'>SRD</span> and the Basic Rules (2014)_
