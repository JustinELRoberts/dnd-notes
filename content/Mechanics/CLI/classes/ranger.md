...
aliases:
  - Ranger
created: 2026-03-30T01:53:55.668Z
modified: 2026-03-30T01:53:55.668Z
published: 2026-03-30T01:53:55.668Z
tags:
...
- **Armor**: [light armor](/Mechanics/CLI/item-types.md#Light%20Armor), [medium armor](/Mechanics/CLI/item-types.md#Medium%20Armor), [shields](/Mechanics/CLI/items/shield.md)
- **Weapons**: simple weapons, martial weapons
- **Tools**: none
- **Skills**: choose 3 from [Animal Handling](/Mechanics/CLI/skills.md#Animal%20Handling), [Athletics](/Mechanics/CLI/skills.md#Athletics), [Insight](/Mechanics/CLI/skills.md#Insight), [Investigation](/Mechanics/CLI/skills.md#Investigation), [Nature](/Mechanics/CLI/skills.md#Nature), [Perception](/Mechanics/CLI/skills.md#Perception), [Stealth](/Mechanics/CLI/skills.md#Stealth), and [Survival](/Mechanics/CLI/skills.md#Survival)

You start with the following items, plus anything provided by your background.

- (a) [scale mail](/Mechanics/CLI/items/scale-mail.md) or (b) [leather armor](/Mechanics/CLI/items/leather-armor.md)
- (a) two [shortswords](/Mechanics/CLI/items/shortsword.md) or (b) two simple melee weapons
- (a) a [dungeoneer's pack](/Mechanics/CLI/items/dungeoneers-pack-xphb.md) or (b) an [explorer's pack](/Mechanics/CLI/items/explorers-pack-xphb.md)
- A [longbow](/Mechanics/CLI/items/longbow.md) and a [quiver](/Mechanics/CLI/items/quiver-xphb.md) of [20 arrows](/Mechanics/CLI/items/arrows-20.md)
...
- **Armor**: [light armor](/Mechanics/CLI/item-types.md#Light%20Armor), [medium armor](/Mechanics/CLI/item-types.md#Medium%20Armor), [shields](/Mechanics/CLI/items/shield.md)
- **Weapons**: simple weapons, martial weapons
- **Skills**: choose 1 from [Animal Handling](/Mechanics/CLI/skills.md#Animal%20Handling), [Athletics](/Mechanics/CLI/skills.md#Athletics), [Insight](/Mechanics/CLI/skills.md#Insight), [Investigation](/Mechanics/CLI/skills.md#Investigation), [Nature](/Mechanics/CLI/skills.md#Nature), [Perception](/Mechanics/CLI/skills.md#Perception), [Stealth](/Mechanics/CLI/skills.md#Stealth), and [Survival](/Mechanics/CLI/skills.md#Survival)
...
You can make a ranger quickly by following these suggestions. First, make Dexterity your highest ability score, followed by Wisdom. (Some rangers who focus on two-weapon fighting make Strength higher than Dexterity.) Second, choose the [outlander](/Mechanics/CLI/backgrounds/outlander.md) background.
...
Choose a type of favored enemy: aberrations, beasts, celestials, constructs, dragons, elementals, fey, fiends, giants, monstrosities, oozes, plants, or undead. Alternatively, you can select two races of humanoid (such as [gnolls](/Mechanics/CLI/bestiary/humanoid/gnoll.md) and [orcs](/Mechanics/CLI/bestiary/humanoid/orc.md)) as favored enemies.

You have advantage on Wisdom ([Survival](/Mechanics/CLI/skills.md#Survival)) checks to track your favored enemies, as well as on Intelligence checks to recall information about them.
...
_1st-level ranger [optional feature](/Mechanics/CLI/variant-rules/optional-class-features-tce.md), which replaces the Favored Enemy feature and works with the Foe Slayer feature_

When you hit a creature with an attack roll, you can call on your mystical bond with nature to mark the target as your favored enemy for 1 minute or until you lose your [concentration](/Mechanics/CLI/conditions.md#Concentration) (as if you were [concentrating](/Mechanics/CLI/conditions.md#Concentration) on a spell).
...
_1st-level ranger [optional feature](/Mechanics/CLI/variant-rules/optional-class-features-tce.md), which replaces the Natural Explorer feature_
...
- [Druidic Warrior](/Mechanics/CLI/feats/druidic-warrior-xphb.md)
...
For example, if you know the 1st-level spell [animal friendship](/Mechanics/CLI/spells/animal-friendship-xphb.md) and have a 1st-level and a 2nd-level spell slot available, you can cast [animal friendship](/Mechanics/CLI/spells/animal-friendship-xphb.md) using either slot.
...
_2nd-level ranger [optional feature](/Mechanics/CLI/variant-rules/optional-class-features-tce.md)_

You can use a [druidic focus](/Mechanics/CLI/items/druidic-focus-xphb.md) as a spellcasting focus for your ranger spells. A druidic focus might be a sprig of mistletoe or holly, a wand or rod made of yew or another special wood, a staff drawn whole from a living tree, or an object incorporating feathers, fur, bones, and teeth from sacred animals.
...
_3rd-level ranger [optional feature](/Mechanics/CLI/variant-rules/optional-class-features-tce.md), which replaces the Primeval Awareness feature_
...
| Ranger Level | Spell |
|--------------|-------|
| 3rd | [speak with animals](/Mechanics/CLI/spells/speak-with-animals-xphb.md) |
| 5th | [beast sense](/Mechanics/CLI/spells/beast-sense-xphb.md) |
| 9th | [speak with plants](/Mechanics/CLI/spells/speak-with-plants-xphb.md) |
| 13th | [locate creature](/Mechanics/CLI/spells/locate-creature-xphb.md) |
| 17th | [commune with nature](/Mechanics/CLI/spells/commune-with-nature-xphb.md) |
^primal-awareness-spells
...
_4th-level ranger [optional feature](/Mechanics/CLI/variant-rules/optional-class-features-tce.md)_

Whenever you reach a level in this class that grants the Ability Score Improvement feature, you can replace a fighting style you know with another fighting style available to rangers. This replacement represents a shift of focus in your martial practice.

### Extra Attack (Level 5)

Beginning at 5th level, you can attack twice, instead of once, whenever you take the [Attack](/Mechanics/CLI/actions.md#Attack) action on your turn.
...
In addition, you have advantage on saving throws against plants that are magically created or manipulated to impede movement, such as those created by the [entangle](/Mechanics/CLI/spells/entangle-xphb.md) spell.

### Hide in Plain Sight (Level 10)

Starting at 10th level, you can spend 1 minute creating camouflage for yourself. You must have access to fresh mud, dirt, plants, soot, and other naturally occurring materials with which to create your camouflage.

Once you are camouflaged in this way, you can try to hide by pressing yourself up against a solid surface, such as a tree or wall, that is at least as tall and wide as you are. You gain a +10 bonus to Dexterity ([Stealth](/Mechanics/CLI/skills.md#Stealth)) checks as long as you remain there without moving or taking actions. Once you move or take an action or a reaction, you must camouflage yourself again to gain this benefit.

### Nature's Veil (Level 10)

_Source: Tasha's Cauldron of Everything p. 56_

_10th-level ranger [optional feature](/Mechanics/CLI/variant-rules/optional-class-features-tce.md), which replaces the Hide in Plain Sight feature_

You draw on the powers of nature to hide yourself from view briefly. As a bonus action, you can magically become [invisible](/Mechanics/CLI/conditions.md#Invisible), along with any equipment you are wearing or carrying, until the start of your next turn.
...
In addition, whenever you finish a short rest, your [exhaustion](/Mechanics/CLI/conditions.md#Exhaustion) level, if any, is decreased by 1.
...
Starting at 14th level, you can use the [Hide](/Mechanics/CLI/actions.md#Hide) action as a bonus action on your turn. Also, you can't be tracked by nonmagical means, unless you choose to leave a trail.
...
> ![Fighting Style, Ranger](/Mechanics/CLI/lists/list-optfeaturetype-fs-r.md#Fighting%20Style,%20Ranger)
> ^list-optfeature-fs-r

## Sources

_Player's Handbook p. 89. Available in the <span title='Systems Reference Document (5.1)'>SRD</span>_
