...
aliases:
  - Tool Proficiencies
created: 2026-03-29T21:53:56.536-04:00
modified: 2026-03-29T21:53:56.536-04:00
published: 2026-03-29T21:53:56.536-04:00
tags:
...
Tools have more specific applications than skills. The [History](/Mechanics/CLI/skills.md#History) skill applies to any event in the past. A tool such as a [forgery kit](/Mechanics/CLI/items/forgery-kit-xphb.md) is used to make fake objects and little else. Thus, why would a character who has the opportunity to acquire one or the other want to gain a tool proficiency instead of proficiency in a skill?
...
In addition, consider giving characters who have both a relevant skill and a relevant tool proficiency an added benefit on a successful check. This benefit might be in the form of more detailed information or could simulate the effect of a different sort of successful check. For example, a character proficient with [mason's tools](/Mechanics/CLI/items/masons-tools-xphb.md) makes a successful Wisdom ([Perception](/Mechanics/CLI/skills.md#Perception)) check to find a secret door in a stone wall. Not only does the character notice the door's presence, but you decide that the tool proficiency entitles the character to an automatic success on an Intelligence ([Investigation](/Mechanics/CLI/skills.md#Investigation)) check to determine how to open the door.
...
Proficiency with [alchemist's supplies](/Mechanics/CLI/items/alchemists-supplies-xphb.md) allows you to unlock more information on [Arcana](/Mechanics/CLI/skills.md#Arcana) checks involving potions and similar materials.
...
Proficiency with [brewer's supplies](/Mechanics/CLI/items/brewers-supplies-xphb.md) gives you additional insight on Intelligence ([History](/Mechanics/CLI/skills.md#History)) checks concerning events that involve alcohol as a significant element.
...
As part of a long rest, you can repair your companions' shoes. For the next 24 hours, up to six creatures of your choice who wear shoes you worked on can travel up to 10 hours a day without making saving throws to avoid [exhaustion](/Mechanics/CLI/conditions.md#Exhaustion).

#### Craft Hidden Compartment

With 8 hours of work, you can add a hidden compartment to a pair of shoes. The compartment can hold an object up to 3 inches long and 1 inch wide and deep. You make an Intelligence check using your tool proficiency to determine the Intelligence ([Investigation](/Mechanics/CLI/skills.md#Investigation)) check DC needed to find the compartment.
...
A [forgery kit](/Mechanics/CLI/items/forgery-kit-xphb.md) can be used in conjunction with the [Arcana](/Mechanics/CLI/skills.md#Arcana) skill to determine if a magic item is real or fake.
...
As part of a short rest, you can produce a forged document no more than one page in length. As part of a long rest, you can produce a document that is up to four pages long. Your Intelligence check using a [forgery kit](/Mechanics/CLI/items/forgery-kit-xphb.md) determines the DC for someone else's Intelligence ([Investigation](/Mechanics/CLI/skills.md#Investigation)) check to spot the fake.
...
Proficiency with [jeweler's tools](/Mechanics/CLI/items/jewelers-tools-xphb.md) grants you knowledge about the reputed mystical uses of gems. This insight proves handy when you make [Arcana](/Mechanics/CLI/skills.md#Arcana) checks related to gems or gem-encrusted items.
...
Your knowledge of poisons has taught you to handle those substances carefully, giving you an edge when you inspect [poisoned](/Mechanics/CLI/conditions.md#Poisoned) objects or try to extract clues from events that involve poison.
...
| Activity | DC |
|----------|----|
| Spot a [poisoned](/Mechanics/CLI/conditions.md#Poisoned) object | 10 |
