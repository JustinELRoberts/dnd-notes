...
aliases:
  - Orien Enforcer
created: 2026-03-30T01:53:55.938Z
modified: 2026-03-30T01:53:55.938Z
published: 2026-03-30T01:53:55.938Z
tags:
...
- **Skills** [Acrobatics](/Mechanics/CLI/skills.md#Acrobatics) +6, [Perception](/Mechanics/CLI/skills.md#Perception) +4
...
***Temporal Disruption (1/Day).*** Trigger: The enforcer takes damage from a melee attack. _Response:_ The enforcer teleports up to 30 feet to an unoccupied space it can see. Each creature within 10 feet of the space the enforcer left must succeed on a DC 13 Constitution saving throw, or its [Speed](/Mechanics/CLI/variant-rules/speed-xphb.md) is halved until the start of the enforcer's next turn.
```
...
_Eberron: Forge of the Artificer p. 83_
