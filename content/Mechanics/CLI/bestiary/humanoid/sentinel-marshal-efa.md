...
- **Skills** [Athletics](/Mechanics/CLI/skills.md#Athletics) +7, [Insight](/Mechanics/CLI/skills.md#Insight) +5, [Perception](/Mechanics/CLI/skills.md#Perception) +8
...
***Longsword.*** *Melee Attack Roll:* `+7`, reach 5 ft. *Hit:* 13 (`2d8 + 4`) Slashing damage, and the target has [Disadvantage](/Mechanics/CLI/variant-rules/disadvantage-xphb.md) on the next attack roll it makes before the start of the marshal's next turn.
