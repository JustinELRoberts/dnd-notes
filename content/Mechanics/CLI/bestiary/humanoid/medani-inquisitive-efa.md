...
- **Skills** [Insight](/Mechanics/CLI/skills.md#Insight) +5, [Investigation](/Mechanics/CLI/skills.md#Investigation) +4
...
***Crooked Staff.*** *Melee Attack Roll:* `+4`, reach 5 ft. *Hit:* 6 (`1d8 + 2`) Bludgeoning damage. If the target is a Medium or smaller creature, it has the [Prone](/Mechanics/CLI/conditions.md#Prone) condition. If the target already has the [Prone](/Mechanics/CLI/conditions.md#Prone) condition, the attack deals an extra 7 (`2d6`) Radiant damage.

***Inquisitive Eye.*** *Wisdom Saving Throw:* DC 13, one creature the inquisitive can see within 60 feet. *Failure:* 10 (`3d6`) Psychic damage, and the target is marked. The inquisitive has [Advantage](/Mechanics/CLI/variant-rules/advantage-xphb.md) on attack rolls against a target it has marked. While marked, the target can't become hidden from the inquisitive, and if it has the [Invisible](/Mechanics/CLI/conditions.md#Invisible) condition, it gains no benefit from that condition against the inquisitive. The mark disappears after 1 minute or when the inquisitive uses this action again. *Success:* Half damage only.
...
_Eberron: Forge of the Artificer p. 82_
