...
***Pounce.*** If the deinonychus moves at least 20 feet straight toward a creature and then hits it with a Claw attack on the same turn, that target must succeed on a DC 12 Strength saving throw or be knocked [prone](/Mechanics/CLI/conditions.md#Prone). If the target is [prone](/Mechanics/CLI/conditions.md#Prone), the deinonychus can make one Bite attack against it as a bonus action.
